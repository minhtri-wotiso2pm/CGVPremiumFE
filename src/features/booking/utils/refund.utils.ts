 ...
 *  would obviously be rejected (already refunded/cancelled, too close to showtime,
 *  or already checked in — refunds are blocked once Booking.Status becomes "Used",
 *  which this correctly excludes by only allowing exactly "paid" through). */
