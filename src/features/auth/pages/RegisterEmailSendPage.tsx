...
import { resendVerifyEmail } from "@/services/api/auth.service";
...
export default function ForgotPasswordPage() {
    ...
    const handleKeyDown = useCallback(
        (e: React.KeyboardEvent) => { if (e.key === "Enter") handleResendVerifyEmail(); },
            ...
            <div className="cgv-root" style={{
                ...
                >
                    ...
                    <p style={{ textAlign: "center", fontSize: 13, color: T.textMuted, letterSpacing: "0.02em", lineHeight: 1.7, marginBottom: 36, padding: "0 4px" }}>
                        Enter your registered email address and we'll resend you a verification email.
                    </p>
